...
import cv2
def memoria(screen_width, screen_height):
    pygame.init() 
    ...
    def comprobar_si_gana():
        ...
        if gana():
            ...
            print("Tiempo utilizado:", used_time_1)
            print("Tiempo restante:" , unused_time_1)
    ...
    def comprobar_si_gana2():
        ...
        if gana2():
            ...
            print("Tiempo utilizado2:", used_time_2)
            print("Tiempo restante2:" , unused_time_2)
            print("Aciertos2:", acierto_2)
            print("Errores2:", error_2)
            ganar2 = True
            juego_iniciado_2 = False
    ...
    def comprobar_si_gana3():
        ...
        if gana3():
            ...
            print("Tiempo utilizado3:", used_time_3)
            print("Tiempo restante3:" , unused_time_3)
            print("Aciertos3:", acierto_3)
            print("Errores3:", error_3)
            ganar3 = True
            juego_iniciado_3 = False
    ...
    def comprobar_si_gana4():
        ...
        if gana4():
            ...
            print("Tiempo utilizado4:", used_time_4)
            print("Tiempo restante4:" , unused_time_4)
            print("Aciertos4:", acierto_4)
            print("Errores4:", error_4)
            ganar4 = True
            juego_iniciado_4 = False
    ...
    def comprobar_si_gana5():
        ...
        if gana5():
            ...
            print("Tiempo utilizado5:", used_time_5)
            print("Tiempo restante5:" , unused_time_5)
            print("Aciertos5:", acierto_5)
            print("Errores5:", error_5)
            ganar5 = True
            juego_iniciado_5 = False
    ...
    def comprobar_si_gana6():
        ...
        if gana6():
            ...
            print("Tiempo utilizado6:", used_time_6)
            print("Tiempo restante6:" , unused_time_6)
            print("Aciertos6:", acierto_6)
            print("Errores6:", error_6)
            ganar6 = True
            juego_iniciado_6 = False
    ...
    def comprobar_si_gana7():
        ...
        if gana7():
            ...
            print("Tiempo utilizado7:", used_time_7)
            print("Tiempo restante7:" , unused_time_7)
            print("Aciertos7:", acierto_7)
            print("Errores7:", error_7)
            ganar7 = True
            juego_iniciado_7 = False
    ...
    def comprobar_si_gana8():
        ...
        if gana8():
            ...
            print("Tiempo utilizado8:", used_time_8)
            print("Tiempo restante8:" , unused_time_8)
            print("Aciertos8:", acierto_8)
            print("Errores8:", error_8)
            ganar8 = True
            juego_iniciado_8 = False
    ...
    def comprobar_si_gana9():
        ...
        if gana9():
            ...
            print("Tiempo utilizado9:", used_time_9)
            print("Tiempo restante9:" , unused_time_9)
            print("Aciertos9:", acierto_9)
            print("Errores9:", error_9)
            ganar9 = True
            juego_iniciado_9 = False
    ...
    def comprobar_si_gana10():
        ...
        if gana10():
            ...
            print("Tiempo utilizado10:", used_time_10)
            print("Tiempo restante10:" , unused_time_10)
            print("Aciertos10:", acierto_10)
            print("Errores10:", error_10)
            ganar10 = True
            juego_iniciado_10 = False
    ...
    #-------------------------------------------------Primero
        ...
        if game_state == 'reflection_1':
            reflection_1()

        if game_state == 'uncompleted_1':
            uncompleted_1()

    #-------------------------------------------------Segundo
        if game_state == 'secondcard':
            actual_state = 1
            level_card(actual_state)
            
        if game_state == 'second_level':
            second_level()

        if game_state == 'Scnd_level':
            Scnd_level()
            state_before_pause = 2 

        if game_state == 'completed_2':
            completed_2()
        
        if game_state == 'recompensa_2':
            recompensa_2()

        if game_state == 'reflection_2':
            reflection_2()

        if game_state == 'uncompleted_2':
            uncompleted_2()
    #-------------------------------------------------Tercero
        if game_state == 'thirdcard':
            actual_state = 2
            level_card(actual_state)
            
        if game_state == 'third_level':
            third_level()

        if game_state == 'Thrd_level':
            Thrd_level()
            state_before_pause = 3 

        if game_state == 'completed_3':
            completed_3()
        
        if game_state == 'recompensa_3':
            recompensa_3()

        if game_state == 'reflection_3':
            reflection_3()

        if game_state == 'uncompleted_3':
            uncompleted_3()
    #-------------------------------------------------Cuarto
        if game_state == 'fourthcard':
            actual_state = 3
            level_card(actual_state)
        
        if game_state == 'fourth_level':
            fourth_level()

        if game_state == 'Frth_level':
            Frth_level()
            state_before_pause = 4 

        if game_state == 'completed_4':
            completed_4()
        
        if game_state == 'recompensa_4':
            recompensa_4()

        if game_state == 'reflection_4':
            reflection_4()

        if game_state == 'uncompleted_4':
            uncompleted_4()
    #-------------------------------------------------Quinto
        if game_state == 'fifthcard':
            actual_state = 4
            level_card(actual_state)
            
        if game_state == 'fifth_level':
            fifth_level()

        if game_state == 'Ffth_level':
            Ffth_level()
            state_before_pause = 5 

        if game_state == 'completed_5':
            completed_5()
        
        if game_state == 'recompensa_5':
            recompensa_5()

        if game_state == 'reflection_5':
            reflection_5()

        if game_state == 'uncompleted_5':
            uncompleted_5()

    #-------------------------------------------------Sexto
        if game_state == 'sixthcard':
            actual_state = 5
            level_card(actual_state)
            
        if game_state == 'sixth_level':
            sixth_level()

        if game_state == 'Sxth_level':
            Sxth_level()
            state_before_pause = 6 

        if game_state == 'completed_6':
            completed_6()
        
        if game_state == 'recompensa_6':
            recompensa_6()

        if game_state == 'reflection_6':
            reflection_6()

        if game_state == 'uncompleted_6':
            uncompleted_6()
    #-------------------------------------------------Septimo
        if game_state == 'seventhcard':
            actual_state = 6
            level_card(actual_state)
            
        if game_state == 'seventh_level':
            seventh_level()

        if game_state == 'Svnth_level':
            Svnth_level()
            state_before_pause = 7 

        if game_state == 'completed_7':
            completed_7()
        
        if game_state == 'recompensa_7':
            recompensa_7()

        if game_state == 'reflection_7':
            reflection_7()

        if game_state == 'uncompleted_7':
            uncompleted_7()
    #-------------------------------------------------Octavo
        if game_state == 'eighthcard':
            actual_state = 7
            level_card(actual_state)
            
        if game_state == 'eighth_level':
            eighth_level()

        if game_state == 'Eighth_level':
            Eighth_level()
            state_before_pause = 8 

        if game_state == 'completed_8':
            completed_8()
        
        if game_state == 'recompensa_8':
            recompensa_8()

        if game_state == 'reflection_8':
            reflection_8()

        if game_state == 'uncompleted_8':
            uncompleted_8()
    #-------------------------------------------------Noveno
        if game_state == 'ninthcard':
            actual_state = 8
            level_card(actual_state)
            
        if game_state == 'ninth_level':
            ninth_level()

        if game_state == 'Nnth_level':
            Nnth_level()
            state_before_pause = 9 

        if game_state == 'completed_9':
            completed_9()
        
        if game_state == 'recompensa_9':
            recompensa_9()

        if game_state == 'reflection_9':
            reflection_9()

        if game_state == 'uncompleted_9':
            uncompleted_9()
    #-------------------------------------------------Decimo
        if game_state == 'tenthcard':
            actual_state = 9
            level_card(actual_state)
            
        if game_state == 'tenth_level':
            tenth_level()

        if game_state == 'Tnth_level':
            Tnth_level()
            state_before_pause = 10 

        if game_state == 'completed_10':
            completed_10()
        
        if game_state == 'recompensa_10':
            recompensa_10()

        if game_state == 'reflection_10':
            reflection_10()

        if game_state == 'uncompleted_10':
            uncompleted_10()
        ...
        if isGame:# and Fst_level:
            if game_state == 'Fst_level':
                tam_cursor = tam_imgs_fst
            if game_state == 'Scnd_level':
                tam_cursor = tam2
            if game_state == 'Thrd_level':
                tam_cursor = tam3
            ...
            posX = max(radius, min(posX, screen_width - radius))
            posY = max(radius, min(posY, screen_height - radius))
            
            screen.blit(pygame.transform.scale(pointer, (diameter, diameter)), (posX - diameter / 2, posY - diameter / 2))
            #pygame.draw.circle(screen, color_black,  (posX, posY), 125, 15)
            #pygame.draw.circle(screen, color_red, (posX, posY), 20)
        ...
        for event in pygame.event.get(): # Evento de pygame
            if event.type == pygame.KEYDOWN: # Evento: Tecla presionada
                ...
                if event.key == pygame.K_b and puede_jugar_2 and game_state == 'Scnd_level':
                    prueba2 = True
                else:
                    prueba2 = False
                # Tercer nivel seleccionar tarjeta con tecla b
                if event.key == pygame.K_b and puede_jugar_3 and game_state == 'Thrd_level':
                    prueba3 = True
                else:
                    prueba3 = False
                # Cuarto nivel seleccionar tarjeta con tecla b
                if event.key == pygame.K_b and puede_jugar_4 and game_state == 'Frth_level':
                    prueba4 = True
                else:
                    prueba4 = False
                # Quinto nivel seleccionar tarjeta con tecla b
                if event.key == pygame.K_b and puede_jugar_5 and game_state == 'Ffth_level':
                    prueba5 = True
                else:
                    prueba5 = False
                # Sexto nivel seleccionar tarjeta con tecla b
                if event.key == pygame.K_b and puede_jugar_6 and game_state == 'Sxth_level':
                    prueba6 = True
                else:
                    prueba6 = False
                # Septimo nivel seleccionar tarjeta con tecla b
                if event.key == pygame.K_b and puede_jugar_7 and game_state == 'Svnth_level':
                    prueba7 = True
                else:
                    prueba7 = False
                # Octavo nivel seleccionar tarjeta con tecla b
                if event.key == pygame.K_b and puede_jugar_8 and game_state == 'Eighth_level':
                    prueba8 = True
                else:
                    prueba8 = False
                # Noveno nivel seleccionar tarjeta con tecla b
                if event.key == pygame.K_b and puede_jugar_9 and game_state == 'Nnth_level':
                    prueba9 = True
                else:
                    prueba9 = False
                # Decimo nivel seleccionar tarjeta con tecla b
                if event.key == pygame.K_b and puede_jugar_10 and game_state == 'Tnth_level':
                    prueba10 = True
                else:
                    prueba10 = False
            ...
            if event.type == start_timer_event and game_state == 'Fst_level': 
                start_time += 1 
                start_timer_text = timer_font.render(str(start_time), True, color_black)
                if start_time == time_limit_1:
                    start_time = 0
                    pygame.time.set_timer(start_timer_event, 0)
                    start_timer_active = False
                    game_state = 'reflection_1'
                    used_time_1 = time_limit_1
                    unused_time_1 = 0
            ...
            if event.type == timer_event_2 and game_state == 'second_level':
                level_time_2 -= 1 
                timer_text_2 = timer_font_2.render(str(level_time_2), True, color_black)
                if level_time_2 <= 0:
            ...
            if event.type == start_timer_event_2 and game_state == 'Scnd_level': 
                start_time_2 += 1 
                start_timer_text_2 = timer_font.render(str(start_time_2), True, color_black)
                if start_time_2 == time_limit_2:
                    start_time_2 = 0
                    pygame.time.set_timer(start_timer_event_2, 0)
                    start_timer_active_2 = False
                    game_state = 'reflection_2'
                    used_time_2 = time_limit_2
                    unused_time_2 = 0
            ...
            if event.type == timer_event_3 and game_state == 'third_level':
                level_time_3 -= 1 
                timer_text_3 = timer_font_3.render(str(level_time_3), True, color_black)
                if level_time_3 <= 0:
                    timer_active_3 = False
                    pygame.time.set_timer(timer_event_3, 0)
                    game_state = 'Thrd_level'

            # Temporizador del tercero
            if event.type == start_timer_event_3 and game_state == 'Thrd_level': 
                start_time_3 += 1 
                start_timer_text_3 = timer_font.render(str(start_time_3), True, color_black)
                if start_time_3 == time_limit_3:
                    start_time_3 = 0
                    pygame.time.set_timer(start_timer_event_3, 0)
                    start_timer_active_3 = False
                    game_state = 'reflection_3'
                    used_time_3 = time_limit_3
                    unused_time_3 = 0
            ...
            if event.type == timer_event_4 and game_state == 'fourth_level':
                level_time_4 -= 1 
                timer_text_4 = timer_font_4.render(str(level_time_4), True, color_black)
                if level_time_4 <= 0:
                    timer_active_4 = False
                    pygame.time.set_timer(timer_event_4, 0)
                    game_state = 'Frth_level'

            # Temporizador del cuarto
            if event.type == start_timer_event_4 and game_state == 'Frth_level': 
                start_time_4 += 1 
                start_timer_text_4 = timer_font.render(str(start_time_4), True, color_black)
                if start_time_4 == time_limit_4:
                    start_time_4 = 0
                    pygame.time.set_timer(start_timer_event_4, 0)
                    start_timer_active_4 = False
                    game_state = 'reflection_4'
                    used_time_4 = time_limit_4
                    unused_time_4 = 0
            ...
            if event.type == timer_event_5 and game_state == 'fifth_level':
                level_time_5 -= 1 
                timer_text_5 = timer_font_5.render(str(level_time_5), True, color_black)
                if level_time_5 <= 0:
                    timer_active_5 = False
                    pygame.time.set_timer(timer_event_5, 0)
                    game_state = 'Ffth_level'

            # Temporizador del quinto
            if event.type == start_timer_event_5 and game_state == 'Ffth_level': 
                start_time_5 += 1 
                start_timer_text_5 = timer_font.render(str(start_time_5), True, color_black)
                if start_time_5 == time_limit_5:
                    start_time_5 = 0
                    pygame.time.set_timer(start_timer_event_5, 0)
                    start_timer_active_5 = False
                    game_state = 'reflection_5'
                    used_time_5 = time_limit_5
                    unused_time_5 = 0
            ...
            if event.type == timer_event_6 and game_state == 'sixth_level':
                level_time_6 -= 1 
                timer_text_6 = timer_font_6.render(str(level_time_6), True, color_black)
                if level_time_6 <= 0:
                    timer_active_6 = False
                    pygame.time.set_timer(timer_event_6, 0)
                    game_state = 'Sxth_level'

            # Temporizador del sexto
            if event.type == start_timer_event_6 and game_state == 'Sxth_level': 
                start_time_6 += 1 
                start_timer_text_6 = timer_font.render(str(start_time_6), True, color_black)
                if start_time_6 == time_limit_6:
                    start_time_6 = 0
                    pygame.time.set_timer(start_timer_event_6, 0)
                    start_timer_active_6 = False
                    game_state = 'reflection_6'
                    used_time_6 = time_limit_6
                    unused_time_6 = 0
            ...
            if event.type == timer_event_7 and game_state == 'seventh_level':
                level_time_7 -= 1 
                timer_text_7 = timer_font_7.render(str(level_time_7), True, color_black)
                if level_time_7 <= 0:
                    timer_active_7 = False
                    pygame.time.set_timer(timer_event_7, 0)
                    game_state = 'Svnth_level'

            # Temporizador del septimo
            if event.type == start_timer_event_7 and game_state == 'Svnth_level': 
                start_time_7 += 1 
                start_timer_text_7 = timer_font.render(str(start_time_7), True, color_black)
                if start_time_7 == time_limit_7:
                    start_time_7 = 0
                    pygame.time.set_timer(start_timer_event_7, 0)
                    start_timer_active_7 = False
                    game_state = 'reflection_7'
                    used_time_7 = time_limit_7
                    unused_time_7 = 0
            ...
            if event.type == timer_event_8 and game_state == 'eighth_level':
                level_time_8 -= 1 
                timer_text_8 = timer_font_8.render(str(level_time_8), True, color_black)
                if level_time_8 <= 0:
                    timer_active_8 = False
                    pygame.time.set_timer(timer_event_8, 0)
                    game_state = 'Eighth_level'

            # Temporizador del octavo
            if event.type == start_timer_event_8 and game_state == 'Eighth_level': 
                start_time_8 += 1 
                start_timer_text_8 = timer_font.render(str(start_time_8), True, color_black)
                if start_time_8 == time_limit_8:
                    start_time_8 = 0
                    pygame.time.set_timer(start_timer_event_8, 0)
                    start_timer_active_8 = False
                    game_state = 'reflection_8'
                    used_time_8 = time_limit_8
                    unused_time_8 = 0
            ...
            if event.type == timer_event_9 and game_state == 'ninth_level':
                level_time_9 -= 1 
                timer_text_9 = timer_font_9.render(str(level_time_9), True, color_black)
                if level_time_9 <= 0:
                    timer_active_9 = False
                    pygame.time.set_timer(timer_event_9, 0)
                    game_state = 'Nnth_level'

            # Temporizador del noveno
            if event.type == start_timer_event_9 and game_state == 'Nnth_level': 
                start_time_9 += 1 
                start_timer_text_9 = timer_font.render(str(start_time_9), True, color_black)
                if start_time_9 == time_limit_9:
                    start_time_9 = 0
                    pygame.time.set_timer(start_timer_event_9, 0)
                    start_timer_active_9 = False
                    game_state = 'reflection_9'
                    used_time_9 = time_limit_9
                    unused_time_9 = 0
            ...
            if event.type == timer_event_10 and game_state == 'tenth_level':
                level_time_10 -= 1 
                timer_text_10 = timer_font_10.render(str(level_time_10), True, color_black)
                if level_time_10 <= 0:
                    timer_active_10 = False
                    pygame.time.set_timer(timer_event_10, 0)
                    game_state = 'Tnth_level'

            # Temporizador del decimo
            if event.type == start_timer_event_10 and game_state == 'Tnth_level': 
                start_time_10 += 1 
                start_timer_text_10 = timer_font.render(str(start_time_10), True, color_black)
                if start_time_10 == time_limit_10:
                    start_time_10 = 0
                    pygame.time.set_timer(start_timer_event_10, 0)
                    start_timer_active_10 = False
                    game_state = 'reflection_10'
                    used_time_10 = time_limit_10
                    unused_time_10 = 0
