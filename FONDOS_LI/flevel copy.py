...
sonido_clic = pygame.mixer.Sound("F_LEVEL/clic.wav")
sonido_exito = pygame.mixer.Sound("F_LEVEL/ganador.wav")
sonido_fracaso = pygame.mixer.Sound("F_LEVEL/equivocado.wav")
sonido_voltear = pygame.mixer.Sound("F_LEVEL/voltear.wav")
...
pantalla_juego = pygame.display.set_mode((screen_width, screenheight))
